...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <main class="py-4">
        ...
        <asp:Panel runat="server" ID="pnlMensaje" CssClass="alert alert-info" Visible="false">
            <asp:Label runat="server" ID="lblMensaje" />
        </asp:Panel>

        <asp:Panel runat="server" ID="pnlDetalle" CssClass="row g-4" Visible="false">
            <div class="col-md-5">
            ...
            <div class="col-md-7">
                ...
                <asp:Label runat="server" ID="lblExito" CssClass="text-success d-block mb-3" Visible="false" />
